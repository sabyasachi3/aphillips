...
import com.xebialabs.aphillips.usertype.examples.take4.EntityWithStringBuilderProperty;
 ...
 * @since Nov 2, 2009
 */
@ContextConfiguration(locations = { "classpath:take4/dataSourceContext.xml "})
