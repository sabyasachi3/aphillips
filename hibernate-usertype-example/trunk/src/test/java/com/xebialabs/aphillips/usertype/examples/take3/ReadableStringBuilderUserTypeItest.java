...
import com.xebialabs.aphillips.usertype.examples.take3.EntityWithStringBuilderProperty;
 ...
 * @since Nov 2, 2009
 */
@ContextConfiguration(locations = { "classpath:take3/dataSourceContext.xml "})
