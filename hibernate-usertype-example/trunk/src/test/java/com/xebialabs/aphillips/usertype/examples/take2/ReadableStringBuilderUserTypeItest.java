 ...
 */
package com.xebialabs.aphillips.usertype.examples.take2;
...
import com.xebialabs.aphillips.usertype.examples.take2.EntityWithStringBuilderProperty;
 ...
 * @since Nov 2, 2009
 */
@ContextConfiguration(locations = { "classpath:take2/dataSourceContext.xml "})
